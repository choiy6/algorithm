...
// 이를 사전순으로 정렬하면 "a", "ana", "anana", "banana", "na", "nana"이므로 ["a", "ana", "anana", "banana", "na", "nana"]를
// return 합니다.
//입출력 예 #2
//
...
// 이를 사전순으로 정렬한 문자열 배열
// ["ammers", "ers", "grammers", "mers", "mmers", "ogrammers", "programmers", "rammers", "rogrammers", "rs", "s"]를
// return 합니다.
public class 접미사배열 {
    public static void main(String[] args) {
        접미사배열 sl = new 접미사배열();
        String my_string = "banana";
        String[] result = sl.solution(my_string);
