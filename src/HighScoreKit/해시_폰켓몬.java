...
import java.util.*;
//문제 설명
//당신은 폰켓몬을 잡기 위한 오랜 여행 끝에, 홍 박사님의 연구실에 도착했습니다. 홍 박사님은 당신에게 자신의 연구실에 있는
...
public class 해시_폰켓몬 {
    public static void main(String[] args){
        해시_폰켓몬 sl = new 해시_폰켓몬();
        int[] nums = {3,3,3,2,2,4};
        int result = sl.solution(nums);
    ...
    public int solution(int[] nums) {
        ...
        // 폰켓몬의 종류별로 개수를 세어 HashMap에 저장
        for (int i : nums) {
            hm.put(i, hm.getOrDefault(i, 0) + 1);
        }
        //   [3,1,2,3]	2     (3,2) (1,1) (2,1)
        //// [3,3,3,2,2,4]	3 (3,3) (2,2) (4,1)

        // 가장 많은 종류의 폰켓몬을 선택하는 방법 찾기
        int max = nums.length / 2;
        int hmSize = hm.size();

        // max는 최대종류 개수이고 hmSize는 중복을 제거한 사이즈이기 때문에 둘 중에 작은거를 고르면 됨.
        answer = Math.min(max, hmSize);
